...
$(document).ready(function() {
    var url = window.location.pathname;
    if (url == "/guesses") {
        alert("As partidas das quartas de final (a partir do jogo 57) começaram a ser adicionadas. Só serão considerados os resultados do tempo normal. Prorrogação e pênaltis não serão levados em conta no resultado do bolão.")
        checkDatetimes(false);
    }
})
